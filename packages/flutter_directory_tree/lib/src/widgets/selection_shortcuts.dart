...
/// Adds common tree keyboard behaviors (arrows, enter, space, select all).
/// Wrap your DirectoryTreeView with this. Works without Material.
///
/// By default this widget requests focus (`autofocus: true`) to match
/// the previous behavior. Set [autofocus] to false if an outer focus
/// widget should manage focus itself. The optional [pageJumpSize]
/// controls how many rows PageUp/PageDown traverse at a time.
